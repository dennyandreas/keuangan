...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-nav" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#page-top">Denny Andreas, S.Kom.MTA  - Programmer Sukadana Lampung Timur</a>
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome to Dompet Keu Singah Kidah Kiyai</h1>
            <p class="lead" style="font-size: 16pt;">Aplikasi pencatatan keuangan harian dengan
                fitur
                transaksi terbaik</p>
            <a href="login" class="btn btn-outline-light button">Memulai Aplikasi</a>
        </div>
    </header>
    <!-- header -->
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">Dompet - Keu</h4>
        ...
        <div class="container text-light">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="mb-0 mt-2">Copyright © 2022 Denny Andreas. All rights reserved
                    </p> 
                </div>
            </div>
        </div>
