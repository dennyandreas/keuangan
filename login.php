...
<head>
  ...
  <title>Login Wah Dak adek Jo</title>
        ...
        <div class="row">
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan Dompet - Keu</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                <div class="login">
                  <h4 class="aktif">LOGIN Adek Jo Wagei</h4>
                </div>
                <div>
                  <h4> / </h4>
                </div>
                <div class="signup">
                  <h4>Kuguk Namo Sekam </h4>
                </div>
                <div class="sub-title">Login untuk gunakan Dompet - Keu</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
